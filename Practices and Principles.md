...
- [Practices & Principles](#practices--principles)
...
|                           |     |
|---------------------------|-----|
| DTO’s                     | Usually the same rules apply to DTO’s as do for entities. Especially if they just transfer data from SQL statements to application logic.<br/>
