...
The [business](#business-layer) layer is like internal, mechanical parts. It defines the rules of the system. It can model the functionality of a software program, but you generally don't see it. 
