...
A benefit of [`SQL`](api.md#sql) scripts is that it always operates on the right intermediate version of the [entity](patterns.md#entity) model, while [`C#`](https://dotnet.microsoft.com/en-us/languages/csharp) code always operates on the latest version of the [entity](patterns.md#entity) model. This means that earlier [`C#`](https://dotnet.microsoft.com/en-us/languages/csharp)-based migrations might not compile anymore for a newer version of the [entity](patterns.md#entity) model, and can only work with an older version of the model.
